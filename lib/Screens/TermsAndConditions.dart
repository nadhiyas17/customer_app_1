    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          mainAxisAlignment:
              MainAxisAlignment.spaceBetween, // Space evenly between children
          children: [
            // Text on the left
            Text(
            ...
            Container(
              color: Colors
                  .transparent, // Ensure container background is transparent
              child: Image.asset(
                'assets/white_logo.png', // Path to your PNG image
        ...
        backgroundColor:
            Color.fromARGB(255, 134, 133, 136), // Adjust color as needed
        leading: IconButton(
